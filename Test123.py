...
fig = px.bar(data_frame=energy_usage, x='year', y='consumption')
...
# Create a simple bar chart
fig = px.bar(data_frame=Steam_players_corona, x='DateTime', y='Users')
...
my_chart = st.bar_chart(data=Steam_players_corona, x='DateTime', y='Users')
...
# Create a simple bar chart
fig = px.bar(data_frame=world_cases, x='Date_reported', y='Cumulative_cases')
...
# Create a simple bar chart
fig = px.bar(data_frame=PS4_concurrent_players, x='dates', y='Player count')
...
st.dataframe(PS4_concurrent_players)
...
#Stukje combineren.
WC4 = pd.concat([world_cases['Cumulative_cases'], Steam_players_corona['Users'], PS4_concurrent_players['Player count']], axis=1)
WC4.columns = ['Corona cases', 'Steam users', 'PS4 Users']
...
WC_corr= WC4.corr(method='pearson')
...
import plotly.express as px
fig = px.scatter(x=WC4["Corona cases"], y=WC4["Steam users"])
